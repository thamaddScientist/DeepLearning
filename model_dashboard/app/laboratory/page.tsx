...
export default function LaboratoryPage() {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      console.log("Base64 String:", base64String.split(",")[1]) // Debugging line

      const requestPayload = {
        image_base64: base64String, // This includes the data:image/jpeg;base64, prefix
      }
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Upload an image to get predictions from the AI model</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>AI model classification results</CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current AI model specifications and capabilities</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              <Label className="text-xs uppercase tracking-wide">Architecture</Label>
              <p className="font-mono text-sm">ResNet-50</p>
            </div>
            <div className="space-y-1">
              <Label className="text-xs uppercase tracking-wide">Input Size</Label>
              <p className="font-mono text-sm">224x224 RGB</p>
            </div>
            <div className="space-y-1">
              <Label className="text-xs uppercase tracking-wide">Classes</Label>
              <p className="font-mono text-sm">1000 ImageNet</p>
            </div>
          </div>
        </CardContent>
      </Card>
